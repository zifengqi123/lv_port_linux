...
{
    /*Your code comes here*/
    sw_devices->keyboard_open();
    sw_devices->keyboard_set_sound(1);
    sw_devices->keyboard_set_backlight(1);
}

static uint8_t act_key ;
static int key_ret = 0;
...
static void keypad_read(lv_indev_t * indev_drv, lv_indev_data_t * data)
{
    ...
    key_ret = sw_devices->keyboard_get_input(act_key);
    if(key_ret == 0) {
        data->state = LV_INDEV_STATE_PRESSED;
